...
/**
 * Inline stroke icons (path data from lucide, ISC licence).
 *
 * Inlined rather than pulling in an icon package: the site ships a handful of
 * glyphs and every byte counts for the SEO pages. Icons are decorative — they
 * are hidden from screen readers and always sit beside visible text.
 */
type IconProps = { size?: number; color?: string; style?: CSSProperties };

const svg = (children: ReactNode) =>
  function Icon({ size = 16, color = 'currentColor', style }: IconProps) {
    return (
      <svg
        aria-hidden="true"
        focusable="false"
...
export const CalendarCheckIcon = svg(<>{calendarFrame}<path d="m9 16 2 2 4-4" /></>);
...
export const CircleAlertIcon = svg(
  <>
...
export const HomeSearchIcon = svg(
  <>
